...
public class QuerySystemConsts {
	public final static String INDEX_DIRECTORY = "index";
	public static final String DATASET_DIRECTORY = "dataset";
	
	public static final String FIELD_TITLE = "filename";
	public static final String FIELD_LABEL = "contents";
	public static final String FIELD_LABEL_RAW = "contents";
